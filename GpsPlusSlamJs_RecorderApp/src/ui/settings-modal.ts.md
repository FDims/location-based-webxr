...
| `images-quality-filter`           | checkbox | Toggle the blur/blackness image-content gate (default **off**, opt-in; disabled when capture off). Thresholds stay internal/hidden until field-tuned |
